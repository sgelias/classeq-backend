...
# [GCC 7.3.0]
# Embedded file name: acutil.py
# Compiled at: 2014-09-26 08:55:10
        ...
        for temp_lag in range(1, lag + 1):
            for j in range(len_phyche_value):
                ...
                for i in range(len_seq - temp_lag - k + 1):
                    ...
                    temp_sum += (float(phyche_value[nucleotide1][j]) - ave_phyche_value) * float(
                        phyche_value[nucleotide2][j])
                ...
                for i2 in range(len_phyche_value):
                    if i1 != i2:
                        ...
                        for j in range(len_seq - temp_lag - k + 1):
                            ...
                            ave_phyche_value1 += float(
                                phyche_value[nucleotide][i1])
                            ave_phyche_value2 += float(
                                phyche_value[nucleotide][i2])
                        ...
                        for j in range(len_seq - temp_lag - k + 1):
                            ...
                            nucleotide2 = sequence[j +
                                                   temp_lag:j + temp_lag + k]
